        ...
        <div class="card">
              <div class="card-header">
               ...
               <div class="col-md-6" style="float:right;">
                <form action="{{route('subCategories.all')}}" method="get">
              ...
              <div class="row overflow-auto">
                  ...
                  <tbody>
                   @foreach ($sub_categories as $sub_category)
                       <tr>
                           <td>
                               <img style="width:150px;" src="{{asset($sub_category->sub_category_image)}}" alt="{{$sub_category->sub_category_name}}">
                           </td>
                           ...
                           @if (Auth::user()->hasPermission('edit_categories'))
                            ...
                            @include('admin.categories.components.edit_sub_category_modal')

                            @endif

                            @if (Auth::user()->hasPermission('delete_categories'))
                
                            @include('admin.categories.components.remove_sub_category_modal')
                            @endif
