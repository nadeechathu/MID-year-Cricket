        ...
        <div class="bg-white border-bottom py-3 mb-5">
            <div
                ...
                <nav class="mb-0" aria-label="breadcrumb">
                    <h3 class="m-0">Edit Club Contacts</h3>
                    ...
                    <form action="{{route('club_contacts.update',['id' => $club_contact->id])}}" method="post" id="{{'resource-form-'.$club_contact->id}}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="">Club Name <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="club_name" value="{{$club_contact->club_name}}" id="club_name" required>
                            </div>

                            <div class="form-group">
                                <label for="">Email <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="email" value="{{$club_contact->email}}" id="club_email" required>
                            </div>

                            <div class="form-group">
                                <label for="">Competition Type <span class="text-danger">*</span> </label>
                            ...
                            <div class="form-group">
                                <label for="">Number of teams <span class="text-danger">*</span> </label>
                            ...
                            <div class="form-group">
                                <label for="">Executive Name <span class="text-danger">*</span> </label>
                            ...
                            <div class="form-group">
                                <label for="">Executive phone <span class="text-danger">*</span> </label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-select" id="status">
                                    ...
                                    <option {{$club_contact->status == 0 ? 'selected' : ''}} value="0">Inactive</option>
                        ...
                        <div class="modal-footer float-start">
                            <button type="submit" class="btn btn-dark text-white">Update Club Contacts</button>
