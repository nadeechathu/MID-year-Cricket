                ...
                <ul class="list-unstyled mb-6">
                    ...
                    @if (Auth::user()->role_id == 1)
                     ...
                     <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            ...
                            <span class="menu-link">Manage Users</span></a>
                        <div class="collapse" id="collapseMenuItemUsers">
                            <ul class="submenu">
                            @if (Auth::user()->hasPermission('add_users'))
                                <li><a href="{{route('users.all')}}">Registered Users</a></li>
                            @endif
                    ...
                    <!-- Posts Menu Section-->
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemCategories" aria-expanded="false"
                            aria-controls="collapseMenuItemCategories">
                            <span class="menu-icon">
                            ...
                            <span class="menu-link">Manage Categories</span></a>
                        <div class="collapse" id="collapseMenuItemCategories">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_categories'))
                    ...
                    @if (Auth::user()->hasPermission('view_sponsors'))
                    <!-- Categories Menu Section-->

                    <!-- Posts Menu Section-->
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemSponsors" aria-expanded="false"
                            aria-controls="collapseMenuItemSponsors">
                            <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                        <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                            ...
                            <span class="menu-link">Sponsors</span></a>
                        <div class="collapse" id="collapseMenuItemSponsors">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_sponsors'))
                                    <li><a href="{{route('sponsors.all')}}">All Sponsors</a></li>
                                @endif
                            </ul>
                        </div>
                    </li>
                    ...
                    <!-- Posts Menu Section-->
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemClubContacts" aria-expanded="false"
                            aria-controls="collapseMenuItemClubContacts">
                            <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                        <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                            ...
                            <span class="menu-link">Club Contacts</span></a>
                        <div class="collapse" id="collapseMenuItemClubContacts">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_contacts'))
                                    <li><a href="{{route('club_contacts.all')}}">All Club Contacts</a></li>
                                @endif
                            </ul>
                        </div>
                    </li>
                    ...
                    <!-- Posts Menu Section-->
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemRules" aria-expanded="false"
                            aria-controls="collapseMenuItemRules">
                            <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                        <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                            ...
                            <span class="menu-link">Rules</span></a>
                        <div class="collapse" id="collapseMenuItemRules">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_rule'))
                                    <li><a href="{{route('rules.all')}}">All Rules</a></li>
                                @endif
                            </ul>
                        </div>
                    </li>
                    ...
                    @if (Auth::user()->hasPermission('view_posts'))
                     ...
                     <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            ...
                            <span class="menu-link">Manage Posts</span></a>
                        <div class="collapse" id="collapseMenuItemPosts">
                            <ul class="submenu">
                                ...
                                @endif
                                @if (Auth::user()->hasPermission('view_posts'))
                                <li><a href="{{route('news.all')}}">News Items</a></li>
                            @endif
                                @if (Auth::user()->hasPermission('add_posts'))
                                    <li><a href="{{route('posts.new')}}">New Post</a></li>
                                @endif
                    ...
                    @endif
                    @if (Auth::user()->hasPermission('view_forms'))
                     <!-- Posts Menu Section-->
                     <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemForms" aria-expanded="false"
                            aria-controls="collapseMenuItemForms">
                            <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                        <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                            ...
                            <span class="menu-link">Manage Forms</span></a>
                        <div class="collapse" id="collapseMenuItemForms">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_forms'))
                                    <li><a href="{{route('forms.all')}}">All Forms</a></li>
                                @endif
                    ...
                    @if (Auth::user()->hasPermission('view_resources'))
                     <!-- Posts Menu Section-->
                     <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                            data-bs-toggle="collapse" data-bs-target="#collapseMenuItemResources" aria-expanded="false"
                            aria-controls="collapseMenuItemResources">
                            <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                        <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                            ...
                            <span class="menu-link">Manage Resources</span></a>
                        <div class="collapse" id="collapseMenuItemResources">
                            <ul class="submenu">
                                @if (Auth::user()->hasPermission('view_resources'))
                    ...
                    <!-- Posts Menu Section-->
                    <li class="menu-item"><a class="d-flex align-items-center collapsed" href="#"
                           data-bs-toggle="collapse" data-bs-target="#collapseMenuItemGallery" aria-expanded="false"
                           aria-controls="collapseMenuItemGallery">
                           <span class="menu-icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                       <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                                       <path opacity="0.5" d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                           ...
                           <span class="menu-link">Manage Gallery</span></a>
                       <div class="collapse" id="collapseMenuItemGallery">
                           <ul class="submenu">
                               @if (Auth::user()->hasPermission('view_gallery'))
                                   <li><a href="{{route('gallery.all')}}">Gallery Images</a></li>
                               @endif
                               @if (Auth::user()->hasPermission('view_categories'))
